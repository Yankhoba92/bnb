 ...
 */
final class Version20240115124252 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE room RENAME COLUMN addres TO address');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE room RENAME COLUMN address TO addres');
    }
}
